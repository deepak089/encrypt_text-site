...
<html lang="en">
  ...
  <br>
   ...
   <button class="btn btn-primary-dark" type="submit" id="gen_shabtn">Generate</button>
   
 
   <button class="btn btn-primary-dark" type="submit" id="shabtn">Encrypt</button>
</div> 
<h1>
  <p id="error"></p>
   <p id="data">
   ...
   $("#gen_shabtn").on("click",function(){
  alert("your key is:"+" "+  +generated_key);
});
       $("#shabtn").click(function(e){
           e.preventDefault();
           var name=$("#name").val();
           var key=$('#key').val();
           $.ajax({
